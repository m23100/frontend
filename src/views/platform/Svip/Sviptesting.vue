        ...
        <template slot-scope="scope">
          <el-popover
            ...
            <div class="item-content">
                <div class="item">
                  <div class="copys">
                    <div class="photo"><img :src="scope.row.copywritingimage.first" width="100" height="100" alt="商品"></div>
                    <div class="descr">
                      ...
                      {{scope.row.copywriting.first}}<br>
                      <img :src="scope.row.copywritingimage.second" width="100" height="100" alt="商品"><br>
                      {{scope.row.copywriting.second}}
                    </div>
                  </div>
