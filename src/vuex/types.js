...
export const SET_GOODS_COVERIMG = 'SET_GOODS_COVERIMG'
export const SET_GOODS_SALECOUNT = 'SET_GOODS_SALECOUNT'
...
export const SET_USERS_BALANCE = 'SET_USERS_BALANCE'